...
- 현재 버전: `1.7.0`
- 기준 요구사항: `docs/requirements/요구사항정의서.md` v2.18
- 공개 API: 59개
...
- AI 서버는 내부 API 7개의 요청 본문과 Example을 Pydantic 모델 기준으로 사용한다.
...
FastAPI 내부 API 7개는 모두 P0다.

## 6명 역할

| 담당 | 소유 범위 |
|---|---|
| AI 서버 1명 | FastAPI 내부 API 7개, 파싱·Wiki 변환 문맥 선택·Wiki 변환·일정 추출·질문 분류·답변 생성 |
