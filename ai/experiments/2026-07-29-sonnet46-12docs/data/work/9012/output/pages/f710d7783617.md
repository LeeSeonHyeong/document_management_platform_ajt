...
소셜 엔지니어링 공격 대응 모범 사례는 [커뮤니케이션 원칙과 규범](pages/d17455afe159.md)의 커뮤니케이션 보안 절에 정리되어 있다[^24].

핵심 원칙: PostHog의 공식 소통은 Slack에서만 이루어진다. 전화·SMS·WhatsApp으로는 요청·승인·민감 정보를 전달하지 않는다. Slack 외 채널로 연락이 오면 신뢰하지 않고 Slack으로 직접 확인한다.
